...
" syn_begin: markdown {{{
" builtin: {{{
call gruvbox_material#highlight('markdownH1', s:palette.bg0, s:palette.red, 'bold')
call gruvbox_material#highlight('markdownH2', s:palette.bg0, s:palette.orange, 'bold')
call gruvbox_material#highlight('markdownH3', s:palette.bg0, s:palette.yellow, 'bold')
call gruvbox_material#highlight('markdownH4', s:palette.bg0, s:palette.green, 'bold')
call gruvbox_material#highlight('markdownH5', s:palette.bg0, s:palette.blue, 'bold')
call gruvbox_material#highlight('markdownH6', s:palette.bg0, s:palette.purple, 'bold')
